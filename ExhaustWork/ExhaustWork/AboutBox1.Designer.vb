...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelCopyright.Text = "Институт при КГТУ"
        ...
        Me.TextBoxDescription.Text = "Разработал данное ПО студент группы ИСТТ"
        '
        'OKButton
        '
